 ...
 * @returns {Uint8Array}
 */
export function compress_image(input, format, quality) {
 ...
 * @returns {Uint8Array}
 */
export function convert_to_webp(input, quality) {
    const ptr0 = passArray8ToWasm0(input, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.convert_to_webp(ptr0, len0, quality);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasmimage_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
